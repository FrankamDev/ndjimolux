...
// ────────────────────────────────────────────────
// Données statiques pour les réalisations (basées sur tes images r1.jpeg, r2.jpeg, etc.)
// J'ai simulé 12 images pour l'exemple (tu peux en ajouter plus). 
// J'ai assigné des catégories logiquement pour le filtrage (cuisine, porte, etc.).
// Les images sont dans /public/, donc accessibles via '/r1.jpeg' etc.
// Si tu as plus d'images (ex: jusqu'à r20.jpeg), ajoute-les dans le tableau.
...
export default function Realisations() {
  // Note: J'ai rendu les données statiques ici (pas de props Inertia pour simplifier).
  // Si tu veux les passer via Inertia, remplace par { realisations }: { realisations: { data: typeof realisationsData } }
  // et utilise projects = realisations.data;
